  ...
  <main class="max-w-screen-2xl 2xl:mx-auto">
    ...
    <div class="mx-5 max-w-[886px] lg:ml-32 xl:ml-[20%]">
      <div class="flex h-[calc(100vh-96px)] flex-col pt-[112px]">
        <div
          class="flex w-fit items-center gap-x-[22px] rounded-[33px] bg-gray py-[10px] pl-2 pr-8"
        >
        ...
        <p
          class="mt-[46px] font-inter text-[28px] font-semibold leading-[40px] sm:text-[48px] sm:leading-[64px]"
        >
          A creative Product Designer with a focus on helping startups and large
          <span class="font-semibold sm:text-[#7E889C]"
            >organizations design modern and user-centric solutions.</span
          >
        </p>

        <div class="mb-28 mt-12 flex gap-x-6 md:mt-20 lg:mb-[144px]">
          <router-link to="#" class="rounded-lg bg-orange px-[26px] py-3 text-lg font-medium"
            >My Resume</router-link
          >
          <router-link
            to="#"
            class="flex items-center gap-x-[10px] rounded-lg bg-gray px-[26px] py-3 text-lg font-medium"
            >Contact Me
            <ChevronRightIcon />
          </router-link>
        </div>
      ...
      <div class="mb-[71px]">
        <div
          class="mb-3 flex w-fit items-center gap-x-2 rounded-[33px] bg-gray py-[10px] pl-2 pr-8"
        >
          <b>💼</b>
